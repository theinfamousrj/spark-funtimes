...
if file_size > file_size_limit:
    ...
    percentile_sql = "SELECT percentile_approx(trip_distance, " + str(percentile) + ") FROM parquet_file"
else:
...
data_sql = "SELECT VendorID, tpep_pickup_datetime, tpep_dropoff_datetime, passenger_count, trip_distance FROM parquet_file WHERE trip_distance > " + str(percentile_value) + " ORDER BY " + order_by
